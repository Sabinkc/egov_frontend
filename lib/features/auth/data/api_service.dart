...
//       "https://egov-backend.vercel.app/api/users/login"; // Replace with actual API
...
//   ) async {
//     _logger.i(
//         "Starting sign-up request for email: $email with name: $fullName and password: $password");
...
//         return jsonDecode(response.body);
//       } else {
//         _logger.d("Request body after failed1: ${jsonEncode(requestBody)}");
...
//       _logger.d("Request body after failed2: ${jsonEncode(requestBody)}");
//       return {
//         "message": "An error occurred. Please try again later.",
//         "errorStack": ""
//       };
